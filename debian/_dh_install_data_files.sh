...
dh_install -p python-obspy-dbg ./debian/tmp/usr/lib/python2.7/dist-packages/obspy/io/mseed/src/libmseed/test/* usr/share/obspy/io/mseed/tests/data/libmseed
